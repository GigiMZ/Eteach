...
urlpatterns = [
    ...
    path('comments/<int:pk>/vote_up', views.comment_up_vote),
    path('comments/<int:pk>/vote_down', views.comment_down_vote),
    path('comments/<int:pk>/vote_up_remove', views.comment_up_vote_remove),
    path('comments/<int:pk>/vote_down_remove', views.comment_down_vote_remove),
